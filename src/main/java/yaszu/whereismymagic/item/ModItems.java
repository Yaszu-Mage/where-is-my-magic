...
public class ModItems {
    ...
    public static final Item MANA_DUST = registerItem("mana_dust", new Item(new FabricItemSettings()));
    public static final Item CRACK = registerItem("crack", new Item(new FabricItemSettings()));
